...
local base = lush(function(injected_functions)
	...
	return {
		...
		sym("@keyword.repeat")({ fg = p.fg, gui = "bold" }),
		sym("@keyword.return")({ fg = p.fg.darken(20), gui = "bold" }),
		sym("@keyword.debug")({ fg = p.fg, gui = "bold" }),
		sym("@keyword.exception")({ fg = p.fg, gui = "bold" }),
		sym("@keyword.conditional")({ fg = p.fg, gui = "bold" }),
		...
		sym("@comment.documentation")({ fg = p.fg_dark }),
